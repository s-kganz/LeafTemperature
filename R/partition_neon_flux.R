...
#' Run REddyProc on NEON eddy covariance data
#'
#' @param site_meta Site metadata table \code{\link{site_meta}}.
#' @param raw_flux Unprocessed flux table generated by [get_neon_flux()].
#' @param tower_dir Directory containing tower data files generated by [get_amf_tower_data()].
#' @param out_dir Output directory where partitioned flux will be written.
#'
#' @description
#' This function groups raw NEON flux data by site-year and passes each one to REddyProc for partitioning into gross primary production and ecosystem respiration. Due to data limitations, we provide all data to REddyProc. Once partitioned, we drop observations with any of the NEON QC flags set.
#'
#' @export
#'
